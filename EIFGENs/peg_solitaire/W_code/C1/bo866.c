...
extern void F866_7684(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 865, Current, 0, 0, 12662);
	RTSA(Dtype(Current));
	RTSC;
...
void F866_7684 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 865, Current, 0, 7683);
	RTSA(dtype);
	RTME(dtype, 0);
